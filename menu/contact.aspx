<%@ Page Language="C#" MasterPageFile="~/Masterpages/MasterPage.master" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="menu_contact" validateRequest="false" Title="Contacts" %>
...
<table class="style1" runat="server" id="FormTable">
  <tr>
    <td colspan="3"><p class="style5">If you have any queries please feel free to contact us at the following e-mail or send your query using the form below. Thank you. </p>
   ...
   <tr>
    <td colspan="3" class="style5"><a href="info@kalihaticollege.edu.bd" class="jk">info@kalihaticollege.edu.bd</a></td></tr>
     <tr><td colspan="3"> &nbsp;</td></tr>
  <tr>
    <td class="style4">
      Your name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
